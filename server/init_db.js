...
const completedGames = [
  {
    ...
    steps: [
      ["North Gate", "Central", "Express tunnel shortcut opens", 14],
      ["Central", "University", "Crowded platform causes a delay", 12],
      ["University", "Airport", "Lost wallet returned to staff", 13],
    ],
  },
  {
    username: "bob",
    ...
    steps: [
      ["Harbor", "Market", "Ticket inspector bonus for a valid pass", 11],
      ["Market", "Central", "Wrong platform announcement", 8],
      ["Central", "Museum", "Street musician improves morale", 11],
      ["Museum", "Hilltop", "Escalator maintenance blocks the exit", 10],
    ],
  },
];
